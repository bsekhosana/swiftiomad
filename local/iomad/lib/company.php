...
class company {
    ...
    public static function upsert_company_user($userid, $companyid, $departmentid, $managertype, $educator=false, $ws=false, $loadmanagertypes=false) {
        global $DB, $CFG;
        ...
        if($loadmanagertypes){
            $managertypes = array('0' => get_string('user', 'block_iomad_company_admin'),'1' => get_string('companymanager', 'block_iomad_company_admin') );
        }
