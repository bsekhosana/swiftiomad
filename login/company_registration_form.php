...
require_once($dirroot.'/custom-php/godaddy_api.php');
require_once($dirroot.'/custom-php/cpanel_api.php');
require_once($dirroot. '/lib/formslib.php');
require_once($dirroot. '/blocks/iomad_company_admin/includes/colourpicker.php');
require_once($dirroot. '/blocks/iomad_company_admin/lib.php');


\MoodleQuickForm::registerElementType('iomad_colourpicker',
    $dirroot . '/blocks/iomad_company_admin/includes/colourpicker.php', 'MoodleQuickForm_iomad_colourpicker');
...
// Set the url.
$linkurl = new moodle_url('/login/company_registration_form.php', [
    //'returnurl' => $returnurl,
    'companyid' => $companyid,
    //'parentid' => $parentid,
    'createnew' => $new,
...
$PAGE->set_url('/login/company_registration_form.php');
// $PAGE->set_pagelayout('admin');
$PAGE->set_title("Company registration");

// Set the page heading.
$PAGE->set_heading("Registration - $linktext");
...
//              updateDns("A", $data->hostname,$_SERVER["SERVER_ADDR"],strtolower($_SERVER["SERVER_NAME"]));
             
//              createSubDomain($data->hostname,strtolower($_SERVER["SERVER_NAME"]),"/public_html/",$_SERVER["SERVER_ADDR"]);
...
//         if(strtolower($oldcompany->hostname) != strtolower($data->hostname)){
            
//             deleteDnsRecord("A", $oldcompany->hostname,$_SERVER["SERVER_ADDR"],strtolower($_SERVER["SERVER_NAME"]));
            
//             deleteSubDomain($oldcompany->hostname,strtolower($_SERVER["SERVER_NAME"]),"/public_html/",$_SERVER["SERVER_ADDR"]);
