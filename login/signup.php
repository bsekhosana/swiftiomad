...
$PAGE->requires->js( new moodle_url($CFG->wwwroot . '/custom-js/reg_page.js'));
...
if ($mform_signup->is_cancelled()) {
    ...
    // var_dump($mform_signup->get_data());
    // die();
    // if($mform_signup->get_data() == NULL){
    //     $user = new stdClass();
    //     $user->companyid = $_POST["companyid"];
    ...
    //     $user->profile_field_type = $_POST["profile_field_type"];
    //     $user->profile_field_long_name = $_POST["profile_field_long_name"];
    //     $user->profile_field_short_name = $_POST ["profile_field_short_name"];
    //     $user->profile_field_hostname = $_POST["profile_field_hostname"];
        
    // }
    // var_dump($CFG->local_iomad_signup_useemail);
    // die();
    ...
    $user->profile_field_short_name = $user->profile_field_long_name;
    $user->profile_field_hostname = $user->profile_field_hostname.'.'.$_SERVER["SERVER_NAME"];
